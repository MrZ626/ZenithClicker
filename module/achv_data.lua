...
Achievements = {
    ...
    { -- quest_feast
        ...
        rank = numberRankRev(600, 550, 500, 450, 400, 350, 200),
    },
    { -- eDPeEX
        --id = 'eDPeEX',
        id = 'best_friends',
        name = "Best Friends",
        desc = [[Most quests cleared with Friend's assistance in 5 minutes WUT "Easy Mode" and "Friend" mods]],
        quote = [["With the power of friendship, we will prevail!"]],
        scoreSimp = function(quest) return floor(quest) .. " Dunks" end,
        rank = numberRank(0, 25, 40, 55, 70, 85, 100),
    }, 
    { -- eGVeIN
        id = 'humble_pupil',
