...
Achievements = {
    ...
    { -- ueEX
        id = 'ueEX',
        name = "Tough",
        desc = [[HFD with the "Uneasy Mode" mod]],
        quote = [[The weight of reality presents its own challenge.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
        hide = function() return not ACHV.uneasy end,
    },
    { -- eNH
        id = 'eNH',
        name = "Cool",
    ...
    { -- eGVeIN
        ...
        desc = [[HFD WUT "Lift" and "Visible" mods]],
        quote = [[TODO]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 4200),
    },
    { -- eASeNH
        ...
        desc = [[HFD WUT "Moderate Hold" and "Spin" mods]],
    ...
    { -- eDPeEX
        id = 'eDPeEX',
        name = "Best Friends",
        desc = [[HFD WUT "Easy Mode" and "Friend" mods]],
    ...
    { -- eGVeNH
        ...
        desc = [[HFD WUT "Moderate Hold" and "Lift" mods]],
    ...
    { -- eDHeMSeNH
        id = 'eDHeMSeNH',
        name = "Clean Break",
        desc = [[HFD WUT "Moderate Hold", "Tidiness" and "Salvation" mods]],
        quote = [[TODO]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
    },
    { -- eDHEXeNH
        ...
        desc = [[HFD WUT "Expert Mode", "Moderate Hold" and "Salvation" mods]],
        quote = [[TODO]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
    },
    { -- eDHeEXeMSeVL
    ...
    { -- eMSeDHeAS
        id = 'eMSeDHeAS',
        name = "Clean Gamer",
        desc = [[HFD WUT "Tidiness", "Salvation" and "Spin" mods]],
    ...
    { -- eEXeMS
        id = 'eEXeMS',
        name = "Quest Feast",
        desc = [[HFD WUT "Easy Mode" and "Tidiness" mods]],
