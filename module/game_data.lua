...
ComboData = {
    ...
    gameeEX = {
        ...
        { set = "eGV eIN",          name = "Humble Pupil" },
        { set = "eGV eAS",          name = "Gaming in Bed" },
        ...
        { set = "eEX eGV eIN",       name = "Comforting Humility" },
        ...
        { set = "eNH eMS eGV",       name = "Snack in Bed" },
        ...
        { set = "eNH eAS eDP",       name = "Overweight Gaming Buddies" },
        { set = "eMS eGV eVL",       name = "Organized Bed" },
        { set = "eMS eGV eDH",       name = "Clean Bed" },
        { set = "eMS eGV eIN",       name = "Pure Humility" },
        ...
        { set = "eEX eNH eGV eDP",    name = "Comfy 'Yoga' in Bed" },
        ...
        { set = "eEX eMS eGV eDP",    name = "Grand Feasts in Bed" },
        { set = "eEX eMS eVL eDH",    name = "Professional Cleaner" },
        ...
        { set = "eEX eGV eVL eIN",    name = "Professional Humility" },
        ...
        { set = "eNH eMS eGV eVL",    name = "Workout Snack in Bed" }, -- snack + true lifter
        { set = "eNH eMS eGV eDH",    name = "Bedroom Snack" },
        { set = "eNH eMS eGV eIN",    name = "Humble Snack" },
        { set = "eNH eMS eGV eAS",    name = "Gamer Snack in Bed" },
        { set = "eNH eMS eGV eDP",    name = "Snack in Bed with a Friend" },
        ...
        { set = "eNH eDH eIN eDP",    name = "Yoga in the Observatory" },
        { set = "eNH eDH eAS eDP",    name = "Yoga in the Gaming Den" },
        ...
        { set = "eMS eGV eVL eAS",    name = "Organized Gaming in Bed" },
        ...
        { set = "eGV eVL eIN eDP",    name = "Calm Memories in Bed" },
        { set = "eGV eVL eAS eDP",    name = "Cuddly Game Dev" },
        { set = "eGV eDH eIN eAS",    name = "Humble Gaming Den" },
        { set = "eGV eDH eIN eDP",    name = "Bedroom Memories" },
