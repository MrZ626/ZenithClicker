...
ComboData = {
    ...
    gameeEX = {
        ...
        { set = "eGV eDP",          name = "Bubble Buddies" },
        ...
        { set = "eIN eDP",          name = "Friendly Vision" },
        ...
        { set = "eEX eMS eAS",       name = "OCD Gaming Addict" },
        ...
        { set = "eEX eGV eDP",       name = "Cuddling in Bed" },
        ...
        { set = "eEX eIN eDP",       name = "Perfect Friend" },
        { set = "eEX eAS eDP",       name = "Friendly Gaming Addict" },
        ...
        { set = "eNH eIN eDP",       name = "Yoga Vision" },
        ...
        { set = "eMS eGV eAS",       name = "OCD Gaming in Bed" },
        ...
        { set = "eMS eAS eDP",       name = "OCD Gaming Buddies" },
        ...
        { set = "eGV eAS eDP",       name = "Gaming in Bed with a Friend" },
        ...
        { set = "eVL eIN eDP",       name = "Obvious Workout Buddies" },
        ...
        { set = "eIN eAS eDP",       name = "Obvious Gaming Buddies" },
        { set = "eEX eNH eMS eGV",    name = "Comforting Snack in Bed" }, 
        { set = "eEX eNH eMS eVL",    name = "Chill Feast" },  
        { set = "eEX eNH eMS eDH",    name = "Clean Spending Spree" },
        { set = "eEX eNH eMS eIN",    name = "Spotless Spending Spree" },
        ...
        { set = "eEX eNH eGV eIN",    name = "Still Water" },
        { set = "eEX eNH eGV eAS",    name = "Shameless Gaming Addict" },
        { set = "eEX eNH eGV eDP",    name = "Shameless Cuddling" },
        { set = "eEX eNH eVL eDH",    name = "Expensive Gym" },
        ...
        { set = "eEX eNH eIN eAS",    name = "Clearly Overweight Gaming Addict" },
        { set = "eEX eNH eIN eDP",    name = "Perfect Yoga" },
        { set = "eEX eNH eAS eDP",    name = "Friendly Overweight Gaming Addict" },
        { set = "eEX eMS eGV eVL",    name = "Eat, Work, Sleep" },
        { set = "eEX eMS eGV eDH",    name = "Bedroom Feast" },
        { set = "eEX eMS eGV eIN",    name = "Humble Feast" },
        { set = "eEX eMS eGV eAS",    name = "Gamer's Feast in Bed" },
        { set = "eEX eMS eGV eDP",    name = "Grand Feasts in Bed" },
        { set = "eEX eMS eVL eDH",    name = "Professional Cleaner" },
        { set = "eEX eMS eVL eIN",    name = "Organized Perfection" },
        { set = "eEX eMS eVL eAS",    name = "The Organized Smithy" },
        ...
        { set = "eEX eMS eIN eDP",    name = "Spotless Best Friends" },
        { set = "eEX eMS eAS eDP",    name = "Gaming Buddies' Feast" },
        { set = "eEX eGV eVL eDH",    name = "Professional Bedroom Gym" },
        ...
        { set = "eEX eGV eDH eIN",    name = "Nap In The Comet Observatory" },
        { set = "eEX eGV eDH eAS",    name = "Gaming Addict's Bedroom" },
        { set = "eEX eGV eDH eDP",    name = "Bedroom Cuddling" },
        { set = "eEX eGV eIN eAS",    name = "Humble Gaming Addict" },
        { set = "eEX eGV eIN eDP",    name = "Humble Cuddling" },
        { set = "eEX eGV eAS eDP",    name = "Cuddling Gamers" },
        { set = "eEX eVL eDH eIN",    name = "Calm Comet Observatory" },
        { set = "eEX eVL eDH eAS",    name = "Smithy's Gaming Den" },
        ...
        { set = "eEX eIN eAS eDP",    name = "Perfect Gaming Buddies" },
        ...
        { set = "eNH eMS eIN eDP",    name = "Spotless Yoga" },
