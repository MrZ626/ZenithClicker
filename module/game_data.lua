...
ComboData = {
    ...
    gameeEX = {
        ...
        { set = "eEX eNH eAS",       name = "Game Buying Spree" },
        ...
        { set = "eEX eGV eAS",       name = "Gaming Addict in Bed" },
        ...
        { set = "eMS eGV eAS",       name = "Hungry Gamer in Bed" },
        { set = "eMS eGV eDP",       name = "Eating Together in Bed" },
        ...
        { set = "eGV eVL eAS",       name = "Game Dev in Bed" },
        ...
        { set = "eEX eNH eGV eAS",    name = "Shameless Gaming Addict" },
        ...
        { set = "eEX eNH eAS eDP",    name = "Comfy Gamer Yoga" },
        ...
        { set = "eNH eGV eVL eAS",    name = "Shameless Game Dev" }, --alt: chill gaming in bed
        ...
        { set = "eEX eNH eMS eIN eAS eDP", name = "Clearly Obese Gaming Buddies" },
