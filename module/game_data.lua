...
ComboData = {
    ...
    gameeEX = {
        { set = "eEX",             name = "Soft Comfort" },
        { set = "eNH",             name = "Cool Meditation" },
        { set = "eMS",             name = "Pure Food" },
        { set = "eGV",             name = "Bubbly Bed" },
        { set = "eVL",             name = "Calm Weightlifter" },
        { set = "eDH",             name = "Sacred Place" },
        { set = "eIN",             name = "Clear Vision" },
        { set = "eAS",             name = "Mystical Gamer" },
        { set = "eDP",             name = "Friendly Buddies" },
        { set = "eEX eNH",          name = "Spending Spree" },
        { set = "eEX eMS",          name = "Block Feast" },
        { set = "eEX eGV",          name = "Comfy Bed" },
        { set = "eEX eVL",          name = "Professional Weightlifter" },
        ...
        { set = "eEX eAS",          name = "Gaming Addict" },
        { set = "eEX eDP",          name = "Best Friends" },
        { set = "eNH eMS",          name = "Snack" },
        { set = "eNH eGV",          name = "Shameless Cashgrab" },
        { set = "eNH eVL",          name = "Chill Weightlifter" },
        { set = "eNH eDH",          name = "Cool Place" },
        { set = "eNH eIN",          name = "Cool Sight" },
        { set = "eNH eAS",          name = "Overweight Gamer" },
        { set = "eNH eDP",          name = "Yoga Buddies" },
        { set = "eMS eGV",          name = "Tidy Bed" },
        { set = "eMS eVL",          name = "Organized Weightlifter" },
        { set = "eMS eDH",          name = "Clean" },
        { set = "eMS eIN",          name = "Spotless Vision" },
        ...
        { set = "eVL eDH",          name = "Gym" },
        { set = "eVL eIN",          name = "Obvious Weightlifter" },
        { set = "eVL eAS",          name = "Game Developer" },
        { set = "eVL eDP",          name = "Workout Buddies" },
        { set = "eDH eIN",          name = "Holy Vision" },
        { set = "eDH eAS",          name = "Holy Gamer" },
        { set = "eDH eDP",          name = "Praying Buddies" },
        ...
        { set = "eEX eMS eIN",       name = "Thanksgiving Visions" },
        { set = "eEX eMS eAS",       name = "OCD Gaming Addict" },
        { set = "eEX eMS eDP",       name = "Grand Feasts" },
        { set = "eEX eGV eVL",       name = "Post Workout Relaxation" },
        ...
        { set = "eEX eVL eIN",       name = "Professional Weightlifter Insight" },
        { set = "eEX eVL eAS",       name = "The Pro G(r)am(m)ing Smithy" },
        { set = "eEX eVL eDP",       name = "Professional Spotlifter" }, -- pro gym buddies
        { set = "eEX eDH eIN",       name = "Heavenly Vision" },
        { set = "eEX eDH eAS",       name = "Heavenly Gamer" },
        { set = "eEX eDH eDP",       name = "Heavenly Friends" },
        ...
        { set = "eNH eVL eDH",       name = "Gym Meditation" },
        { set = "NH VL IN",       name = "Justice" },
        { set = "NH VL AS",       name = "Bob Ross" },
        { set = "NH VL DP",       name = "Insecure Neediness" },
        { set = "NH DH IN",       name = "Blindside" },
