...
DevScore = { clicker = 997939, contender = 8963, elegance = 382920, garbage_offensive = 1929640, tower_climber = 5754994.6, tower_regular = 27490, speed_player = 5571, divine_challenger = 53441.2, zenith_speedrun_plus = 28.87, zenith_challenger = 89682.07, zenith_speedrun = 48.891, supercharged = 288, typer_speedrun = 10.558548782, DP = 10598.95, EX = 8612.63, VL = 6275.59, NH = 10586.4, MS = 5384.91, IN = 9293.06, GV = 10604.39, plonk = 148.99, zenith_explorer = 10666.27, zenith_explorer_plus = 18681.62, clicker_speedrun = 16.29665856, rVL = 6036.9, rNH = 6282.1, rMS = 3721.81, multitasker = 61866.8, effective = 41446.887071386, rEX = 2807.73, rDP = 3980.74, rDH = 4273.85, rAS = 12315.11, zenith_speedrunner = 494.575, divine_speedrunner = 691.846, the_spike_of_all_time = 437, the_spike_of_all_time_minus = 192, clock_out = 678, vip_list = 78, GVIN = 9358.41, ASNH = 14508.3, DPEX = 5417.82, GVNH = 8373.29, DHMSNH = 4603.14, DHEXNH = 6784.1, DHEXMSVL = 2766.57, ASEXVL = 4432.7, swamp_water_lite = 4878.84, swamp_water = 2985.03, DHEXrGV = 6096.52, rASrGV = 12092.56, rGVrIN = 6076.5, NHrAS = 9560.7, GVrASrDH = 3595.35, EXGVNHrMS = 2860.57, ASDPGVrMSrNH = 2005.6, DHrEXrVL = 1664.66, ASGVrDPrMS = 1853.87, NHVLrDPrGV = 2178.42, VLrEXrIN = 1688.17, rDPrEX = 1721.17, INMSrDHrEX = 1244.64, ASMSrDHrIN = 773.9, swamp_water_lite_plus = 4878.84, swamp_water_plus = 2714.92, blight = 7733.35, desolation = 6284.45, havoc = 3656.14, pandemonium = 2068.58, inferno = 1775.53, purgatory = 1395.49, perdition = 1395.49, cataclysm = 1395.49, annihilation = 777.19, armageddon = 423.31, abyss = 196.02, talentless = 7817.15, quest_rationing = 631.02, the_responsible_one = 18, the_unreliable_one = 14, the_responsible_one_plus = 98, guardian_angel = 6061.19, carried = 5528.27, level_19_cap = 7207.94, the_escape_artist = 132, fel_magic = 107, powerless = 5845.4, empurple = 2919.81, patience_is_a_virtue = 2627.37, spotless = 2916.6, honeymoon = 2449.79, break_up = 2046.91, overprotection = 1986.85, clutch_main = 191, sunk_cost = 3980.74, wax_wings = 2412.74, the_masterful_juggler = 122, the_oblivious_artist = 117, speed_bonus = 10, arrogance = 772.74, the_pacifist = 350, detail_oriented = 0, psychokinesis = 1673.9, lovers_promise = 10598.95, divine_rejection = 1649.9, moon_struck = 0, love_hotel = 2.597011165, financially_responsible = 5.898309714, unfair_battle = 4.344901018, museum_heist = 2.4841288230001, workaholic = 2.3799148589999, human_experiment = 2.733007991, thermal_anomaly = 0.46684615700001, ultra_dash = 0.49600276799998, perfect_speedrun = 23.747579831, the_perfectionist = 8310.52, cruise_control = 21, drag_racing = 29, dazed = 16, the_spike_of_all_time_plus = 498, cut_off = 0, worn_out = 0, the_harbinger = 0, final_defiance = 0, speedrun_speedrunning = 0, abyss_weaver = 0, royal_resistance = 0, lovers_stand = 0, romantic_homicide = 0, blazing_speed = 0, its_kinda_rare = 0, benevolent_ambition = 0, fruitless_effort = 0, false_god = 0, respectful = 0, zenith_relocation = 0, intended_glitch = 0, lucky_coincidence = 0, dark_force = 0, zenith_traveler = 0, smooth_dismount = 0, DH = 9644.52, AS = 18681.62, supercharged_plus = 447, rIN = 5503.13, rGV = 8520, identity = 0 }
