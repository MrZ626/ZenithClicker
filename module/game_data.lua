...
-- Trevor Smithy Dev scores
    ...
    emperor_development=13.23,quest_feast=281.00,best_friends=101,humble_pupil=5.68,shameless_cashgrab=130,overweight_gamer=69,clean_gamer=319,clean_break=312,professional_cleaner=100
}
