...
ComboData = {
    ...
    gameeEX = {
        ...
        { set = "eEX eMS eGV",       name = "Thanksgiving Nap" },
        { set = "eEX eMS eVL",       name = "Thanksgiving Workout" },
        { set = "eEX eMS eDH",       name = "Easy to Clean" },
        { set = "eEX eMS eIN",       name = "Thanksgiving Vision" },
        { set = "eEX eMS eAS",       name = "OCD Gaming Addict" },
        { set = "eEX eMS eDP",       name = "Grand Feasts" },
        { set = "eEX eGV eVL",       name = "Professional True Lifter" },
        { set = "eEX eGV eDH",       name = "Heavenly Bed" },
        ...
        { set = "eEX eIN eAS",       name = "Mystically Perfect Vision" }, -- hmm
        { set = "eEX eIN eDP",       name = "Friendly Perfect Vision" }, -- hmm
        ...
        { set = "eNH eGV eAS",       name = "Cashgrab Gamer" },
        ...
        { set = "eGV eIN eDP",       name = "Friendly Pupils" },
