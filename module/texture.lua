...
TEXTURE = {
    ...
    card = {
        ...
        star = {
            EX = { lock = '_lockover_9', front = assets 'card/star/expert.png', back = assets 'card/zc/expert-back.png' },
            NH = { lock = '_lockfull_2', front = assets 'card/star/nohold.png', back = assets 'card/zc/nohold-back.png' },
            MS = { lock = '_lockfull_3', front = assets 'card/star/messy.png', back = assets 'card/zc/messy-back.png' },
            GV = { lock = '_lockfull_4', front = assets 'card/star/gravity.png', back = assets 'card/zc/gravity-back.png' },
            VL = { lock = '_lockfull_5', front = assets 'card/star/volatile.png', back = assets 'card/zc/volatile-back.png' },
            DH = { lock = '_lockfull_6', front = assets 'card/star/doublehole.png', back = assets 'card/zc/doublehole-back.png' },
            IN = { lock = '_lockfull_7', front = assets 'card/star/invisible.png', back = assets 'card/zc/invisible-back.png' },
            AS = { lock = '_lockfull_8', front = assets 'card/star/allspin.png', back = assets 'card/zc/allspin-back.png' },
            DP = { lock = '_lockover_?', front = assets 'card/star/duo.png', back = assets 'card/zc/duo-back.png' },
            lockfull = assets 'card/lockfull.png',
            lockover = assets 'card/lockover.png',
        },
    },
